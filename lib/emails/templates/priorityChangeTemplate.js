/**
 * Template de Email - Alteração de Prioridade de Cliente
 * Sempre usa o formato de tabela (lote), mesmo para 1 cliente.
 */

function gerarHTMLAlteracaoPrioridade(dados) {
  ...
  if (dados.changes && Array.isArray(dados.changes) && dados.changes.length > 0) {
    ...
    changes = [{
      ...
      previousPriority: dados.previousPriority,
      newPriority: dados.newPriority,
    }];
  }
...
export default gerarHTMLAlteracaoPrioridade;