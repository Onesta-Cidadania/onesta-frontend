...
function gerarHTMLAlteracaoStatus(dados) {
  ...
  if (isBatch) {
    ...
    headerText = 'ALTERAÇÃO DE STATUS DOS CLIENTES';
    
    const rows = dados.changes.map(change => {
...
<body style="margin:0; padding:0; background-color:#f3f4f6; font-family: Inter, Arial, sans-serif;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:20px;">
          ...
          <tr>
            <td style="padding:20px;">
              ...
              <p style="margin:0; color:#374151; font-size:14px;">
                <b>Total de alterações:</b> ${dados.changes.length} cliente(s)
              </p>
    ...
    headerText = 'NOTIFICAÇÃO DE ALTERAÇÃO';
